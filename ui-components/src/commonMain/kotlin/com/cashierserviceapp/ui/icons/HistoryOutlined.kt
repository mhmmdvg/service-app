...
val HistoryOutlined: ImageVector
    get() {
        if (_HistoryOutlined != null) return _HistoryOutlined!!
        
        _HistoryOutlined = ImageVector.Builder(
        ...
        return _HistoryOutlined!!
    }

private var _HistoryOutlined: ImageVector? = null

@PreviewLightDark
@Composable
private fun HistoryOutlinedPreview() = PreviewHelper {
    Image(
        imageVector = HistoryOutlined,
